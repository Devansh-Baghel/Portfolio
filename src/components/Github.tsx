...
export default function Github() {
  ...
  return (
    ...
    >
      <h3 className="gitroll-title motion-preset-slide-right mb-4 font-heading text-4xl">Commit History</h3>
      {/* 
        <div className="mb-4">
          <LatestCommit />
        </div> */}
      ...
      <div className="flex flex-col gap-6">
        {years.map((year, index) => (
          <div key={year} className={`motion-preset-slide-right ${index > 0 ? `motion-delay-${index * 120}` : ''}`}>
