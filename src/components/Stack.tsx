...
export default function TechStack() {
  return (
    ...
    >
      <h3 className="tech-stack-title motion-preset-slide-down mb-4 font-heading text-4xl">
      ...
      <div className="stack-wrapper flex grid-cols-[2.2fr_0.9fr] grid-rows-[1fr_1fr] flex-col gap-6 md:grid">
        <div className="col-start-1 col-end-2 row-start-1 row-end-2">
          <div className="wrapper motion-preset-slide-down rounded-[30px] border-[3px] border-slate-900 p-6 shadow-[4px_4px_0px_0px_#1e293b] transition-all duration-200 hover:translate-x-1 hover:translate-y-1 hover:shadow-none">
        ...
        <div className="col-start-1 col-end-2 row-start-2 row-end-3">
          <div className="wrapper motion-preset-slide-up rounded-[30px] border-[3px] border-slate-900 p-6 shadow-[4px_4px_0px_0px_#1e293b] transition-all duration-200 hover:translate-x-1 hover:translate-y-1 hover:shadow-none">
        ...
        <div className="col-start-2 col-end-3 row-start-1 row-end-3 md:h-full">
          <div className="wrapper motion-preset-slide-right rounded-[30px] border-[3px] border-slate-900 p-6 shadow-[4px_4px_0px_0px_#1e293b] transition-all duration-200 hover:translate-x-1 hover:translate-y-1 hover:shadow-none md:h-full">
