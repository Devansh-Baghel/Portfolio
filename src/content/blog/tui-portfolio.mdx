...
<attach image here: full screenshot of the TUI portfolio running in a terminal, showing the ASCII art "DEVANSH BAGHEL" header on the left sidebar and the Home/About section on the right>
...
<attach image here: screenshot of the Projects section in the TUI, showing project cards with tech stack badges in cyan and Live Demo/Source Code links>
...
<attach image here: screenshot of the command palette overlay showing GitHub, LinkedIn, Twitter, Email, Resume options with keyboard navigation hints at the bottom>
...
<attach image here: close-up screenshot of just the ASCII art "DEVANSH BAGHEL" header in lime green on the dark background>
...
<attach image here: screenshot of the contact form section in the TUI, showing Name, Email, Message fields with a Send Message button and lime green focus highlights>
